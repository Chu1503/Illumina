...
const AboutIllumina = () => {
  return (
    <header>
      ...
      <div className='cta'>
      <div className='Logo'><img src="https://cdn.discordapp.com/attachments/894801439992475768/1109183336334762096/logo.png" width="300" alt="LOGO" style={{ display: 'block', margin: '0 auto' }}/></div>
      </div>
